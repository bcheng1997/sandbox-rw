...
create_clock -add -name sys_clk_pin -period 100.00 -waveform {0 50} [get_ports { i_clk }];
...
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { o_dout_valid }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { o_ready }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
...
set_property IO_BUFFER_TYPE OBUF [ get_ports { o_dout o_dout_valid o_ready } ]
set_property IO_BUFFER_TYPE IBUF [ get_ports { i_clk i_en i_rst i_din i_din_valid i_ready } ]
...
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { i_din_valid }]; #IO_L4N_T0_35 Sch=BTN1
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { i_ready }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
